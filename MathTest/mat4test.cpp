...
#include "../MathsLib/MathLibrary.h"
...
{		
	...
	public:
		...
		TEST_METHOD(Mat4Camera)
		{
			...
			TestEqual(matLookAt, matLookAtCalc, 3 * std::numeric_limits<float>::epsilon()); // m_32 is negative in test but positive in my result, I assume that the test is wrong here

			// INVALID TEST, 23 and 32 are switched around, matrix is transposed
